...
import com.painani.app.MainActivity
 ...
 *
 * The tracker itself lives in [com.painani.app.AppContainer] so the UI can observe it directly;
...
class RunTrackingService : Service() {
    ...
    private val tracker: LocationRunTracker get() = (application as PainaniApp).container.runTracker
    ...
    private fun acquireWakeLock() {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "painani:run").apply {
    ...
    companion object {
        ...
        const val ACTION_START = "com.painani.app.tracking.START"
        const val ACTION_PAUSE = "com.painani.app.tracking.PAUSE"
        const val ACTION_RESUME = "com.painani.app.tracking.RESUME"
        const val ACTION_STOP = "com.painani.app.tracking.STOP"
